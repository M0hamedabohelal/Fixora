...
import { Search, MoreVertical, Phone, ChevronLeft, Send, Paperclip, CheckCheck, Loader2 } from 'lucide-react';
    ...
    const unsubscribe = onSnapshot(q, async (snapshot) => {
      try {
        const chatsPromises = snapshot.docs.map(async (docSnap) => {
          ...
          let otherName = data.participantDetails?.[otherParticipantId]?.name || 'Professional';
