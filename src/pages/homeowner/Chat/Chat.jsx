...
import { Search, MoreVertical, Phone, ChevronLeft, Send, Paperclip, CheckCheck } from 'lucide-react';
...
export default function Chat() {
  ...
  const messages = [
    { id: 1, sender: 'them', text: 'Hello! I saw your request for the AC repair.', time: '10:30 AM' },
    { id: 2, sender: 'me', text: 'Hi Ahmed! Yes, it stopped cooling yesterday.', time: '10:31 AM' },
    { id: 3, sender: 'them', text: 'I can come over today at 2 PM if that works for you.', time: '10:35 AM' },
    { id: 4, sender: 'me', text: 'Perfect. See you then!', time: '10:36 AM' },
    { id: 5, sender: 'them', text: 'I will arrive in 15 minutes.', time: '10:42 AM' },
  ];
    ...
    <div className="min-h-screen bg-[#F7F5F2] font-sans pb-32">
      ...
      <div className="bg-[#1f3b6c] pt-8 pb-6 px-6 relative overflow-hidden rounded-b-3xl shadow-sm">
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex items-center justify-between">
          <Link to="/dashboard" className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/20 transition">
            <ChevronLeft className="w-5 h-5" />
          </Link>
          <h1 className="text-white font-bold text-xl tracking-wide">Messages</h1>
            ...
            <React.Fragment key={chat.id}>
              ...
              >
                <div className="relative shrink-0">
                  <img src={chat.avatar} alt={chat.name} className="w-14 h-14 rounded-full object-cover border border-slate-200 group-hover:border-[#1f3b6c] transition-colors" />
