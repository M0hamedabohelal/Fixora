          ...
          {!submitted ? (
            ...
            >
              ...
              <section>
                ...
                <div className="relative w-full h-48 rounded-2xl overflow-hidden shadow-sm border-2 border-white group cursor-pointer mb-2">
                  <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=800&auto=format&fit=crop" alt="Map Location" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-[#1f3b6c]/10 group-hover:bg-transparent transition-colors"></div>
                  
                  {/* Map Pin Center */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 drop-shadow-2xl">
                    <div className="w-10 h-10 bg-[#1f3b6c] rounded-full flex items-center justify-center text-white relative animate-bounce">
                      <MapPin className="w-5 h-5" />
                      <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-[#1f3b6c] rotate-45 rounded-sm"></div>
                    </div>
                  </div>
                  
                  {/* Address Box */}
                  <div className="absolute bottom-3 left-3 right-3 bg-white/95 backdrop-blur-xl px-4 py-3 rounded-xl border border-white flex items-center justify-between shadow-lg">
                    <div className="flex items-center gap-3 overflow-hidden">
                      ...
                      <span className="font-semibold text-slate-800 text-sm truncate">Riyadh, Al Nuzha District, St 42</span>
                    </div>
                    <span className="text-xs font-bold text-[#c9a765] bg-[#c9a765]/10 px-3 py-1.5 rounded-lg shrink-0">Edit Pin</span>
                  </div>
                </div>
              </section>
